...
# Creiamo la cartella workspace dell'utente (ma non ci scriviamo dentro nulla!)
mkdir -p "$WORKSPACE/skills"

# ------------------------------------------------------------------------------
# 3. INSTALLAZIONE SKILL DI SISTEMA (INTERNA)
# ------------------------------------------------------------------------------
# Installiamo ClawHub nella cartella interna del bot, non nel workspace utente.
# Così il bot sa come installare cose, ma non sporca la tua cartella.
bashio::log.info "Configurazione skill interna: ClawHub..."

INTERNAL_SKILLS_DIR="/root/.nanobot/skills"
mkdir -p "$INTERNAL_SKILLS_DIR/clawhub"

# Nota: Qui usiamo $WORKSPACE solo come destinazione per le FUTURE installazioni
...
System tool to search and install new skills into the user workspace.
...
## Install
\`\`\`bash
npx --yes clawhub@latest install "\$1" --workdir "$WORKSPACE"
\`\`\`
...
# ------------------------------------------------------------------------------
# 4. FIX WEATHER TOOL (Opzionale, utile per test veloci)
# ------------------------------------------------------------------------------
